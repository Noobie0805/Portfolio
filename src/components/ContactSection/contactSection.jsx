...
const ContactSection = () => {
  const handleStartConversation = () => {
    const subject = "Let's Collaborate - Portfolio Inquiry";
    const body = "Hi Sarvjeet,\n\nI'd love to discuss potential collaboration opportunities with you. I believe we could make a great team!\n\nBest regards,\n[Your Name]";
    const mailtoLink = `mailto:sarvjeet852003@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
